<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:91:"C:\PHPStudy\WWW\1.0.0.20180417_full\public/../application/common\view\tpl\dispatch_jump.tpl";i:1523974191;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
    ...
    <body>
        ...
        <div class="system-message <?php echo $codeText; ?>">
            <div class="image">
                <img src="/1.0.0.20180417_full/public/assets/img/<?php echo $codeText; ?>.svg" alt="" width="150" />
            </div>
            <h1><?php echo $msg; ?></h1>
            <p class="jump">
